...
import { IEmployeeDataModalEditState } from '../Models/IEmployeeDataModalEditState';

export class ModalEditEmployeeData extends React.Component<{}, IEmployeeDataModalEditState> {
    public state: IEmployeeDataModalEditState = {
        showModal: false,
        key: "",
        name: "",
        value: "",
