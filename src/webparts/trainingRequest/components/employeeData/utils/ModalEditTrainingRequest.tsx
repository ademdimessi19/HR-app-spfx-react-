...
import { ITrainingRequestModalEditState } from '../Models/ITrainingRequestModalEditState';

export class ModalEditTrainingRequest extends React.Component<{}, ITrainingRequestModalEditState> {
    public state: ITrainingRequestModalEditState = {
        showModal: false,
        key: "",
        name: "",
        value: "",
